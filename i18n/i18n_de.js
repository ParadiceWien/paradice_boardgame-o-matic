...
// Footer
const TEXT_ABOUT_THIS_TOOL = "Über den Brettspiel-O-Mat";
...
const TEXT_BTN_PERMALINK_SHARE =
   "<i class='bx bx-sm bxs-share-alt' ></i> Ergebnisse teilen";
const TEXT_BTN_PERMALINK_SAVE =
   "<i class='bx bx-sm bxs-save' ></i> Ergebnisse speichern";
...
const TEXT_WELCOME_AFTER_PERMALINK_SAVE = `<p><strong>Willkommen zurück!</strong> Deine Brettspiel-O-Mat-Ergebnisse haben hier geduldig auf dich gewartet. Sollte sich an deinem Ranking irgendwas geändert haben, liegt das daran, dass sich die Spiele-Datenbank geändert hat (deine Ergebnisse sollten jetzt noch besser sein).</p>
...
const TEXT_BUTTON_ABOVE_RESULTS_SHORT_FILTER_RESULTS =
   "<i class='bx bx-sm bxs-filter-alt'></i> Filtere deine Ergebnisse";
